...
Orchestrator::Testing.mock_device 'Maxhub::Tv' do
    ...
    exec(:power, true)
        ...
        .responds("\xAA\xBB\xCC\x80\x00\x00\x80\xDD\xEE\xFF") # this response is probably wrong
    ...
    exec(:switch_to, "pc")
        ...
        .responds("\xAA\xBB\xCC\x81\x05\x00\x86\xDD\xEE\xFF") # this response is probably incorrect
    ...
    exec(:volume, 99)
        ...
        .responds("\xAA\xBB\xCC\x82\x00\x06\x09\xDD\xEE\xFF") # this is not the correct response
