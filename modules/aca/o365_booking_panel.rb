...
class Aca::O365BookingPanel
    ...
    def fetch_bookings(*args)
        response = @client.get_bookings(mailboxes: [@office_room], options: {bookings_from: Time.now.midnight, bookings_to: Time.now.tomorrow.midnight}).dig(@office_room, :bookings)
        puts "==============================\n#{response}\n==============================="
